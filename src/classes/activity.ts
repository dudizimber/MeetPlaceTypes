...
export class Activity {
    ...
    static fromFirestore(snap: DocumentSnapshot) {
        ...
        data.schedulingOptions.startDate = data.schedulingOptions.startDate instanceof Timestamp ? data.schedulingOptions.startDate.toDate() : data.schedulingOptions.startDate;
        data.schedulingOptions.endDate = data.schedulingOptions.endDate instanceof Timestamp ? data.schedulingOptions.endDate.toDate() : data.schedulingOptions.endDate;
