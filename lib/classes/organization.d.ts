...
export declare class Organization {
    ...
    constructor($organizationId: string, $name: string, $logoUrl: string, $tenantId: string, $email: string, $city: string, $country: string, $organizationType: OrganizationType);
