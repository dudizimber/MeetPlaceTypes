...
var Participant = /** @class */ (function () {
    function Participant($firstName, $lastName, $email, $participantId, $roomCount, $avatar, $documentId) {
    ...
    Participant.fromMap = function (data) {
        return new Participant(data.firstName, data.lastName, data.email, data.participantId, data.roomCount, data.avatar, data.documentId);
    };
